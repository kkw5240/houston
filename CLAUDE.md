...
> 📦 **Lazy-loaded skill**: `/houston-blocker` — invoke via Claude Code Skills harness when triggers match. Full content: `.houston/skills/houston-blocker.md`.
...
> 📦 **Lazy-loaded skill**: `/houston-ticket` — invoke via Claude Code Skills harness when triggers match. Full content: `.houston/skills/houston-ticket.md`.
...
> 📦 **Lazy-loaded skill**: `/houston-test-strategy` — invoke via Claude Code Skills harness when triggers match. Full content: `.houston/skills/houston-test-strategy.md`.
...
> 📦 **Lazy-loaded skill**: `/houston-hotfix` — invoke via Claude Code Skills harness when triggers match. Full content: `.houston/skills/houston-hotfix.md`.
...
> 📦 **Lazy-loaded skill**: `/houston-daily-scrum` — invoke via Claude Code Skills harness when triggers match. Full content: `.houston/skills/houston-daily-scrum.md`.
